...
class cosmo:
    ...
    def hi_class_pk(self, k, z , nonlinear):
        ...
        #self.params['P_k_max_h/Mpc'] = self.params['P_k_max_h/Mpc']
        if nonlinear:
        ...
        cosmo.compute()
        #end = time.time()
        #print(f"Time took {end - start:.4f} seconds for CLASS AND COMPUTE\n")
        ...
        #end = time.time()
        #print(f"Time took {end - start:.4f} seconds for GET_PK_ALL\n")
        ...
        #end = time.time()
        #print(f"Time took {end - start:.4f} seconds for GET_BACKGROUND\n")


        cosmo.struct_cleanup()
        cosmo.empty()
        #end_new = time.time()
        #print(f"Time took {end_new - start_new:.4f} seconds for ALL HI_CLASS_PK\n")

        return background, k_out, z_out, pk_nl.T   # Pk shape (len(z), len(k))
